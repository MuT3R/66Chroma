...
?>
    ...
    <!-- Ouvrir peushpé get_template_part('template-parts/nav/social-nav');
    Fermer peushpé
    -->
...
<?php get_template_part('template-parts/portfolio/'.$randomName1.'-portfolio'); ?>
    </div>
...
<?php get_template_part('template-parts/portfolio/'.$randomName2.'-portfolio'); ?>
    </div>
